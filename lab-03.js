...
/* after comment out the previous. Consult your notes to see how destructuring is done*/
...
const getCarMakeModelImplicit = (car) => vin + " " + year;
...
const {reverseString} = require('./lab-03-module'); // Import and use reverseString() and concatenateString() in
console.log(concatenateString("abc"));
console.log(reverseString("abc"));

console.log(concatenateString(reverseString("abc")));

//I couldn't figure out why the reverseString function wasn't working
//Says "TypeError: str is not iterable"
